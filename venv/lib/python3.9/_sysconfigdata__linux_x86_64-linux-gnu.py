...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/workspaces/deploymachinelearning/venv/bin',
 'BINLIBDEST': '/workspaces/deploymachinelearning/venv/lib/python3.9',
 'BLDLIBRARY': 'libpython3.9.a',
 'BLDSHARED': 'gcc -pthread -B /workspaces/deploymachinelearning/venv/compiler_compat -shared  '
              ''
              ''
              '-Wl,--allow-shlib-undefined '
              '-Wl,-rpath,/workspaces/deploymachinelearning/venv/lib '
              '-Wl,-rpath-link,/workspaces/deploymachinelearning/venv/lib '
              '-L/workspaces/deploymachinelearning/venv/lib '
              ''
              ''
              '-Wl,--allow-shlib-undefined '
              '-Wl,-rpath,/workspaces/deploymachinelearning/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /workspaces/deploymachinelearning/venv/compiler_compat',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -fwrapv -O2 -Wall '
           '-fPIC '
           '-O2   '
           '-isystem '
           '/workspaces/deploymachinelearning/venv/include '
           ''
           ''
           ''
           '-fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/workspaces/deploymachinelearning/venv/include '
                       '-I/workspaces/deploymachinelearning/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,--allow-shlib-undefined '
                      '-Wl,-rpath,/workspaces/deploymachinelearning/venv/lib '
 ...
 'CONFIGURE_LDFLAGS_NODIST': ''
                             '-g',
 'CONFIG_ARGS': "'--prefix=/workspaces/deploymachinelearning/venv'"
                "'--build=x86_64-conda_cos6-linux-gnu'"
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/workspaces/deploymachinelearning/venv/share/zoneinfo:/workspaces/deploymachinelearning/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-ffi'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/workspaces/deploymachinelearning/venv/include'"
                "'--with-tcltk-libs=-L/workspaces/deploymachinelearning/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/workspaces/deploymachinelearning/venv/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/workspaces/deploymachinelearning/venv/include',
 'CONFINCLUDEPY': '/workspaces/deploymachinelearning/venv/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/workspaces/deploymachinelearning/venv/include '
             '-I/workspaces/deploymachinelearning/venv/include',
 'CXX': 'g++ -pthread -B /workspaces/deploymachinelearning/venv/compiler_compat',
 'DESTDIRS': '/workspaces/deploymachinelearning/venv '
             '/workspaces/deploymachinelearning/venv/lib '
             '/workspaces/deploymachinelearning/venv/lib/python3.9 '
             '/workspaces/deploymachinelearning/venv/lib/python3.9/lib-dynload',
 'DESTLIB': '/workspaces/deploymachinelearning/venv/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/workspaces/deploymachinelearning/venv/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/workspaces/deploymachinelearning/venv/include '
                   '/workspaces/deploymachinelearning/venv/include '
                   '/workspaces/deploymachinelearning/venv/include/python3.9 '
                   '/workspaces/deploymachinelearning/venv/include/python3.9',
 'INCLUDEDIR': '/workspaces/deploymachinelearning/venv/include',
 'INCLUDEPY': '/workspaces/deploymachinelearning/venv/include/python3.9',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /workspaces/deploymachinelearning/venv/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,--allow-shlib-undefined '
            '-Wl,-rpath,/workspaces/deploymachinelearning/venv/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -B /workspaces/deploymachinelearning/venv/compiler_compat -shared  '
             ''
             ''
             '-Wl,--allow-shlib-undefined '
             '-Wl,-rpath,/workspaces/deploymachinelearning/venv/lib '
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/workspaces/deploymachinelearning/venv/lib/python3.9',
 'LIBDIR': '/workspaces/deploymachinelearning/venv/lib',
 'LIBFFI_INCLUDEDIR': '/workspaces/deploymachinelearning/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/workspaces/deploymachinelearning/venv/lib/pkgconfig',
 'LIBPL': '/workspaces/deploymachinelearning/venv/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LINKCC': 'gcc -pthread -B /workspaces/deploymachinelearning/venv/compiler_compat',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/workspaces/deploymachinelearning/venv/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread -B /workspaces/deploymachinelearning/venv/compiler_compat',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/home/conda/feedstock_root/build_artifacts/python-split_1727717763064/work/Modules/makesetup',
 'MANDIR': '/workspaces/deploymachinelearning/venv/share/man',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/workspaces/deploymachinelearning/venv/include',
 'OPENSSL_LDFLAGS': '-L/workspaces/deploymachinelearning/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/workspaces/deploymachinelearning/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/workspaces/deploymachinelearning/venv/include',
 'TCLTK_LIBS': '-L/workspaces/deploymachinelearning/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/workspaces/deploymachinelearning/venv/share/zoneinfo:/workspaces/deploymachinelearning/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3 '
 ...
 'datarootdir': '/workspaces/deploymachinelearning/venv/share',
 'exec_prefix': '/workspaces/deploymachinelearning/venv',
 'prefix': '/workspaces/deploymachinelearning/venv',
